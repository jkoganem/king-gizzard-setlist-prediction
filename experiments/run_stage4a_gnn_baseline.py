#!/usr/bin/env python3
"""
Stage 4A: Temporal Sets GNN with Feature Dropout (Production-Ready)
...
def main():
    ...
    FEATURE_DROPOUT = 0.0  # No dropout (baseline)
    print(
    ...
    # Save model
    output_path = Path("output/models/stage4/stage4a_gnn_baseline.pt")
    ...
    results_path = Path("output/reports/stage4/stage4a_results.json")
